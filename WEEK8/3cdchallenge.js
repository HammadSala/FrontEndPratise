...
// The age() method accepts an argument which is the year in which we want to find the age of that car.ie, 
// if the argument is 2022 and the year of car manufacturing is 2014 so age() will return 2022-2014=8.

 

// Now create the object of the above class and set the name and manufacturing year of the car as “Ford”,2012 
...
class Car {
    ...
    age(){
        ...
        var age = new Date().getUTCFullYear() - this.make;
        console.log("Age of the car is :" + age);

    }
}

const obj1 = new Car("ford", 2012)
